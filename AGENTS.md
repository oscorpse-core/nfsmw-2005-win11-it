...
| GitHub Releases | Playable pack **v1.0.1** (no QoL inside until explicit decision) |
...
QoL career freeze on `-qol`: **CLOSED**. No backlog. Public Release still **v1.0.1** without QoL.
