...
**Originale pack:** intatto (`...\nfsmw-2005-win11-it`) — pubblico **vanilla v1.0.1** + **QoL v1.1.0-qol**  
...
| Nuova Release pack QoL | **SHIPPED** `v1.1.0-qol` |
...
| Pubblicare QoL in Release | **SHIPPED** `v1.1.0-qol` | Dual tag live |
